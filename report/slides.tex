...
\author[Group 12]{\texorpdfstring{Group 12\\[0.25em]\small Yingqi Tan \textbullet{} Hao Yang \textbullet{} Zhesheng Xu}{Group 12: Yingqi Tan, Hao Yang, Zhesheng Xu}}
...
\begin{frame}{The question}
  ...
  + merchant files). Analysis in R; all visualizations built in Tableau.
\end{frame}
...
\begin{frame}{Headline: Cainiao is faster overall}
  \begin{columns}
    ...
    \begin{column}{0.46\textwidth}
      \centering
      \includegraphics[width=\textwidth,trim=0 32 0 0,clip]{tab_headline.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Stable over time}
  \centering
  \includegraphics[width=0.86\textwidth,trim=0 32 0 0,clip]{tab_trend.png}
\end{frame}

% 5 -- dashboard centerpiece
\begin{frame}{...BUT the advantage is uneven --- the punchline}
  \centering
  \includegraphics[width=0.96\textwidth,trim=0 32 0 0,clip]{tab_punchline.png}

  \footnotesize Tableau decision dashboard --- big-city\,$\times$\,small-carrier
  cell highlighted in red.
\end{frame}

% 5b -- composite decision dashboard (R)
\begin{frame}{The whole story on one screen}
  \centering
  \includegraphics[height=0.82\textheight]{dash1_story.png}

  {\footnotesize KPI strip $+$ 2$\times$2 breakdown $+$ hours-saved (reversal $-$3.3\,h in red).}
\end{frame}
...
\begin{frame}{Customers feel it too}
  \centering
  \includegraphics[width=0.8\textwidth,trim=0 32 0 0,clip]{tab_reviews.png}
...
\begin{frame}{Mechanism: it's line-haul, not the last mile}
  \begin{columns}
    ...
    \begin{column}{0.5\textwidth}
      \centering
      \includegraphics[width=\textwidth,trim=0 32 0 0,clip]{tab_segments.png}
    \end{column}
  \end{columns}
\end{frame}

% 8b -- composite mechanism dashboard (R)
\begin{frame}{Mechanism, faceted: last-mile is flat, line-haul carries the gap}
  \centering
  \includegraphics[height=0.82\textheight]{dash2_mechanism.png}
\end{frame}
...
\begin{frame}[plain]
  ...
  \normalsize Yingqi Tan \textbullet{} Hao Yang \textbullet{} Zhesheng Xu \\[0.5em]
  Questions?
  \vfill
  {\footnotesize Code, report \& data pipeline:\\[0.2em]
  \url{https://github.com/ericxuzhesheng/Buad345-final-project}}
\end{frame}
