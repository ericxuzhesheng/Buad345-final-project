...
\begin{frame}{Headline: Cainiao is faster overall}
  \begin{columns}
    ...
    \begin{column}{0.46\textwidth}
      \centering
      \includegraphics[width=\textwidth]{tab_headline.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Stable over time}
  \centering
  \includegraphics[width=0.86\textwidth]{tab_trend.png}
\end{frame}

% 5 -- dashboard centerpiece
\begin{frame}{...BUT the advantage is uneven --- the punchline}
  \centering
  \includegraphics[width=0.86\textwidth]{tab_punchline.png}
...
\begin{frame}{Customers feel it too}
  \centering
  \includegraphics[height=0.58\textheight]{tab_reviews.png}
...
\begin{frame}{Mechanism: it's line-haul, not the last mile}
  \begin{columns}
    ...
    \begin{column}{0.5\textwidth}
      \centering
      \includegraphics[width=\textwidth]{tab_segments.png}
    \end{column}
  \end{columns}
\end{frame}
